...
Shader "Ciconia Studio/Effects/Triplanar/Diffuse (3maps)" {
    Properties {
...
/////// Diffuse:
                ...
                float3 diffuseColor = (__DiffuseColor.rgb*(node_869.r*_DiffuseSideXSpecA_var.rgb + node_869.g*_DiffuseTopDownYSpecA_var.rgb + node_869.b*_DiffuseSideZSpecA_var.rgb));
