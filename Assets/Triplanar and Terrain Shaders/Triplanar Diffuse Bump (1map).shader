...
/////// Vectors:
                ...
                float3 node_3179 = pow(abs(i.normalDir),lerp(0.1,2,_Powervalue));
                ...
                float3 _NormalMapX = UnpackNormal(tex2D(__Normalmap,TRANSFORM_TEX(node_7833, __Normalmap)));
                ...
                float3 _NormalMapGround = UnpackNormal(tex2D(__Normalmap,TRANSFORM_TEX(node_7729, __Normalmap)));
                ...
                float3 _NormalMapy = UnpackNormal(tex2D(__Normalmap,TRANSFORM_TEX(node_8964, __Normalmap)));
                float3 normalLocal = normalize(lerp(float3(0,0,1),(node_3179.r*_NormalMapX.rgb + node_3179.g*_NormalMapGround.rgb + node_3179.b*_NormalMapy.rgb),lerp(0,2,_NormalIntensity)));
...
////// Specular:
                ...
                float4 node_7302 = tex2D(_DiffusemapSpecA,TRANSFORM_TEX(node_7833, _DiffusemapSpecA));
                float4 node_844 = tex2D(_DiffusemapSpecA,TRANSFORM_TEX(node_7729, _DiffusemapSpecA));
                float4 node_9841 = tex2D(_DiffusemapSpecA,TRANSFORM_TEX(node_8964, _DiffusemapSpecA));
                float3 specularColor = (__SpecularColor.rgb*lerp(0,5,_SpecularIntensity)*(node_7302.a*node_844.b*node_9841.a));
...
/////// Diffuse:
                ...
                float3 diffuseColor = (__DiffuseColor.rgb*(node_3179.r*node_7302.rgb + node_3179.g*node_844.rgb + node_3179.b*node_9841.rgb));
