...
Shader "Ciconia Studio/Effects/Triplanar/Diffuse Bump(3maps)" {
    Properties {
        ...
        _NormalSideX ("Normal Side (X)", 2D) = "bump" {}
        _NormalSideZ ("Normal Side (Z)", 2D) = "bump" {}
...
/////// Vectors:
                ...
                float3 node_9280 = pow(abs(i.normalDir),lerp(0.1,2,_Powervalue));
                ...
                float3 _NormalSideX_var = UnpackNormal(tex2D(_NormalSideX,TRANSFORM_TEX(node_7833, _NormalSideX)));
                ...
                float3 _NormalSideZ_var = UnpackNormal(tex2D(_NormalSideZ,TRANSFORM_TEX(node_8964, _NormalSideZ)));
                float3 normalLocal = normalize(lerp(float3(0,0,1),(node_9280.r*_NormalSideX_var.rgb + node_9280.g*__NormalTopDownY_var.rgb + node_9280.b*_NormalSideZ_var.rgb),lerp(0,2,_NormalIntensity)));
...
////// Specular:
                ...
                float3 specularColor = (__SpecularColor.rgb*lerp(0,5,_SpecularIntensity)*(_DiffuseSideXSpecA_var.a*_DiffuseTopDownYSpecA_var.b*_DiffuseSideZSpecA_var.a));
...
/////// Diffuse:
                ...
                float3 diffuseColor = (__DiffuseColor.rgb*(node_9280.r*_DiffuseSideXSpecA_var.rgb + node_9280.g*_DiffuseTopDownYSpecA_var.rgb + node_9280.b*_DiffuseSideZSpecA_var.rgb));
