...
/////// Diffuse:
                ...
                float3 node_4748 = pow(abs(i.normalDir),lerp(0.1,2,_Powervalue));
                ...
                float3 diffuseColor = (__DiffuseColor.rgb*(node_4748.r*node_7302.rgb + node_4748.g*_Diffusemap_var.rgb + node_4748.b*node_9841.rgb));
